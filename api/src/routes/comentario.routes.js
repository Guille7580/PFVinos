...
const {
  ...
  updateComentario,
  deleteComentario
} = require('../controllers/controllerComentario')
...
comentarioRouter.post(
  '/',
  [
    check('descripcion', 'El campo descripcion es requerido')
      .trim()
      .not()
      .isEmpty(),
    check('productoId', 'El campo productoId es un valor numérico requerido')
      .trim()
      .not()
      .isEmpty()
      .isInt()
...
// @access Private
comentarioRouter.put(
  '/:id',
  [
    check(
      'descripcion',
      'El campo "descripcion" es requerido y tiene un minimo de 10 caracteres y máximo 350'
    )
      .isString()
      .trim()
